...
// import { Blockcain, IHashTransactionInput } from '../lib/blockchain';
...
// 	const nonce = 239158;
// 	const currentTransaction: IHashTransactionInput = {
// 		index: 1,
// 		pendingTransactions: [
// 			{
// 				amount: 100,
...
// 	const currentTransactionCopy: IHashTransactionInput = { ...currentTransaction };

// 	const currentTransaction2: IHashTransactionInput = {
// 		index: 1,
// 		pendingTransactions: [
// 			{
// 				amount: 150,
...
// 	const hash = dogecoin.hashBlock(previousHash, currentTransaction, nonce);
// 	const hashCopy = dogecoin.hashBlock(previousHash, currentTransactionCopy, nonce);
// 	const hash2 = dogecoin.hashBlock(previousHash, currentTransaction2, nonce);
...
// 	t.deepEqual(hash, '0000ffb3437f308c7214a1f8930df578e427c45445cc704893be1541ba5598a5');
